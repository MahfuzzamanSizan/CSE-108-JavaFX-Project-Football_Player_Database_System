...
public class FileWork {
    ...
    private static final String OUTPUT_FILE_NAME = "newPlayers.txt";
    ...
    public static void writeToFile(List<Player> playerList) throws Exception {
        ...
        for (Player p : playerList) {
            bw.write(p.getName() + "," + p.getCountry() + "," + p.getAge() + "," + p.getHeight() + "," + p.getClub() + "," + p.getPosition() + "," + p.getJerseyNumber() + "," + p.getSalary());
            bw.write("\n");
        }
        bw.close();
    }
